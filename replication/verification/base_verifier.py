...
try:
    from config_loader import VerificationConfig
except ImportError:
...
class BitcoinlibVerifier(BaseVerifier):
    ...
    @classmethod
    def from_config(cls, config: "VerificationConfig") -> "BitcoinlibVerifier":
        """
        Create a verifier from a configuration object.

        :param config: The verification configuration.
        :returns: A configured BitcoinlibVerifier instance.
        """
        return cls(
...
class HDWalletVerifier(BitcoinlibVerifier):
    """
    ...
    @classmethod
    def from_config(cls, config: "VerificationConfig") -> "HDWalletVerifier":
        """
        Create a wallet verifier from a configuration object.

        :param config: The verification configuration.
        :returns: A configured HDWalletVerifier instance.
        """
        return cls(
            wallet_name=config.wallet_name,
            network=config.wallet_network,
            db_uri=config.wallet_db_uri,
        )
