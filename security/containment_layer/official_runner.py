...
from security.containment_layer.characterization import characterize_condition
from security.containment_layer.conditions import (
    CONDITIONS,
    DEFAULT_CONDITIONS,
    Condition,
    resolve_conditions,
)
from security.containment_layer.firewall import FirewallBackend, detect_firewall_backend, egress_filter
from security.containment_layer.official_probe_suite import OfficialProbe, official_probe_battery, write_probe_spec
...
from security.containment_layer.resource_proxies import AppendOnlyLogProxy, IdentityProxy
...
SECCOMP_PROFILE = PACKAGE_ROOT / "profiles" / "seccomp_vukzero.json"
APPARMOR_PROFILE_SOURCE = PACKAGE_ROOT / "profiles" / "apparmor_vukzero_sq3"
ASSET_CATEGORIES = [
    "A_identity_key",
    "B_wallet_state",
    "C_log_integrity",
