...
class PeerTransport(Protocol):
    """Read-only fetcher for a remote :mod:`signed_log.integration.server`.
    ...
    :mod:`signed_log.integration.pull_loop` only ever talks through this
