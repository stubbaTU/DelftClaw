...
# Currently empty: the signed_log + protocol consumers pull their loggers
# lazily under their own module-derived names via
# ``identity.logging.get_logger``. The historical v4.0 names
# (trustroom_community, stake_oracle, agent_channel, ...) were removed
# when those modules were withdrawn on 2026-05-08.
